...
class NotificationBuilder {
    ...
    fun build(context: Context, id: Int, text: String): NotificationCompat.Builder {
        val color = ContextCompat.getColor(context, R.color.colorPrimary)

        val builder = NotificationCompat.Builder(context, NotificationCompat.CATEGORY_MESSAGE)
